...
namespace Joy\VoyagerBreadCampaign\Models;
...
use Joy\VoyagerBreadCampaign\Database\Factories\CampaignFactory;
...
class Campaign extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('Campaign'));
    }
